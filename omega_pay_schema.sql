...
-- 6. Cards
-- Purpose: Stores Omega card details and links them to wallets.
CREATE TABLE cards (
...
-- 7. Tokens
-- Purpose: Stores tokenized card details for secure payments (e.g., Apple Pay).
CREATE TABLE tokens (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE merchants (
    ...
    api_key TEXT NOT NULL, -- For secure communication
...
-- 9. Payment Requests
-- Purpose: Records payment requests initiated by merchants.
...
-- Purpose: Records all payment-related transactions (authorization, reservation, settlement, decline).
